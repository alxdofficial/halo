...
- **`data/scripts/curate/deployment_policy.py`** — device/placement/channel selection + gravity reconstruction
- **`data/scripts/curate/accel_units.py`** — accelerometer unit → g (runs *after* deployment_policy)
